...
backup_home="/home/alam/dump/mount2"
...
cp $backup_dir/$date_stamp.tar.gz $backup_dir/$current_month\_$current_year/
fi
...
begin_backup_process
compress_dump
bash $backup_home/purge_backup.sh --server backup_server --dir $backup_dir --backup_days_required $required_days_of_backup
